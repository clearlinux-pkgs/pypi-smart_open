...
Version  : 1.5.1
Release  : 5
URL      : http://pypi.debian.net/smart_open/smart_open-1.5.1.tar.gz
Source0  : http://pypi.debian.net/smart_open/smart_open-1.5.1.tar.gz
...
%prep
%setup -q -n smart_open-1.5.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489772979
