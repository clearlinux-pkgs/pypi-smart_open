...
Source0  : https://files.pythonhosted.org/packages/da/2c/af1fc367c4d9f07693873e71c3bff770d2adecd193735fc11b45508090fa/smart_open-5.0.0.tar.gz
...
%prep
%setup -q -n smart_open-5.0.0
cd %{_builddir}/smart_open-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617119040
...
cp %{_builddir}/smart_open-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/smart_open/088eeb3fff4ab23573e49bd76ebf2c0e02b5ea51
