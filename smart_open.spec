...
Version  : 1.11.1
Release  : 43
URL      : https://files.pythonhosted.org/packages/5d/13/a2db017db801d0157fdc41814658396e6ae398d06adf69d73df1c8175b5d/smart_open-1.11.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/5d/13/a2db017db801d0157fdc41814658396e6ae398d06adf69d73df1c8175b5d/smart_open-1.11.1.tar.gz
...
%prep
%setup -q -n smart_open-1.11.1
cd %{_builddir}/smart_open-1.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586358044
...
cp %{_builddir}/smart_open-1.11.1/LICENSE %{buildroot}/usr/share/package-licenses/smart_open/088eeb3fff4ab23573e49bd76ebf2c0e02b5ea51
