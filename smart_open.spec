...
Source0  : https://files.pythonhosted.org/packages/c3/ff/f8ac652bc62fc78a35b0201d922e43da63e3469a6eab1d71776af6dd7844/smart_open-4.2.0.tar.gz
...
%prep
%setup -q -n smart_open-4.2.0
cd %{_builddir}/smart_open-4.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613413570
...
cp %{_builddir}/smart_open-4.2.0/LICENSE %{buildroot}/usr/share/package-licenses/smart_open/088eeb3fff4ab23573e49bd76ebf2c0e02b5ea51
